                ...
                <ul className="footer__menu">
                  <li className="footer__item">
                    <Link href="/it-consulting">
                      {t("it-consulting", {}, "IT Consulting")}
                    </Link>
                  </li>
                  <li className="footer__item">
                    <Link href="/marketing-consulting">
                      {t("marketing-consulting", {}, "Marketing Consulting")}
                    </Link>
                  </li>
                  <li className="footer__item">
                    <Link href="/complex-solutions">
                      {t("complex-solutions", {}, "Complex Solutions")}
                    </Link>
                  </li>
                </ul>
                <ul className="footer__menu">
                  <li className="footer__item">
                    <Link href="/faq">{t("faq", {}, "FAQ")}</Link>
                  </li>
                  <li className="footer__item">
                    <Link href="/how-we-work">
                      {t("how-we-work", {}, "How We Work")}
                    </Link>
                  </li>
                  <li className="footer__item">
                    <Link href="/market-research">
                      {t("market-research", {}, "Market Research")}
                    </Link>
                  </li>
                </ul>
                <ul className="footer__menu">
