        ...
        <div className="newsroom-main__body">
          <motion.article
            ...
            <div className="newsroom-main__col-02">
              <h2 className="newsroom-main__title">We’re Officially Here!</h2>
              <p className="newsroom-main__text">Our new website is live, marking our official launch. We’ve combined our freelance expertise into a unified company to deliver top IT and marketing solutions. Explore our services now.</p>
          ...
          <motion.article
            ...
            <div className="newsroom-main__col-02">
              <h2 className="newsroom-main__title">Our Participation in SMX <br /> Advanced Europe 2024</h2>
              <p className="newsroom-main__text">We’re heading to SMX Advanced Europe in Berlin on September 10-11! Discover cutting-edge SEO and PPC strategies with us. Stay tuned for updates, and follow us for the latest news!</p>
