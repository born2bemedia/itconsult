            ...
            <tbody>
                <tr>
                    <td style="padding: 50px 40px; font-family: Roboto, sans-serif; color:#0A0A0A;">
                        ...
                        <p style="font-size: 16px; line-height: 19px;">Our team is currently reviewing your request and will reach out to you soon to discuss your specific challenges and how we can address them. Your urgency level has been noted as</p>
                        <p style="font-size: 16px; line-height: 19px;"><span style="color: #008967; font-weight: 600;">${urgency}</span>, and we will prioritise your inquiry accordingly.</p>
                        <p style="font-size: 16px; line-height: 19px;">If you have any immediate questions or additional information to share, please don't hesitate to contact us at <a href="mailto:info@nexoria.ai" style="color: #008967; font-weight: 600;text-decoration: underline;"></a>.</p>
