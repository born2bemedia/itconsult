                    ...
                    <motion.div
                        ...
                        <div className="faq-main__col-02">
                            <motion.h2
                                ...
                                dangerouslySetInnerHTML={{ __html: t("items.question1", {}, "How can we improve our website’s SEO performance without overhauling our <br /> entire site design?") }}
                                />
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                    ...
                    <motion.div
                        ...
                        <div className="faq-main__col-02">
                            <motion.h2
                                ...
                                custom={0.2}
                                className="faq-main__title"
                                dangerouslySetInnerHTML={{ __html: t("items.question2", {}, "We’re struggling with data management and analysis across multiple <br /> departments. How can Nexoria help us streamline our data processes?") }}
                                />
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                    ...
                    <motion.div
                        ...
                        <div className="faq-main__col-02">
                            <motion.h2
                                ...
                                custom={0.2}
                                className="faq-main__title"
                                dangerouslySetInnerHTML={{ __html: t("items.question3", {}, "How can marketing automation help us manage lead generation and improve <br /> customer engagement?") }}
                                />
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                    ...
                    <motion.div
                        ...
                        <div className="faq-main__col-02">
                            <motion.h2
                                ...
                                custom={0.2}
                                className="faq-main__title"
                                dangerouslySetInnerHTML={{ __html: t("items.question4", {}, "Our business is expanding internationally. How can Nexoria help us manage <br /> our IT infrastructure for multiple locations?") }}
                                />
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                    ...
                    <motion.div
                        ...
                        <div className="faq-main__col-02">
                            <motion.h2
                                ...
                                custom={0.2}
                                className="faq-main__title"
                                dangerouslySetInnerHTML={{ __html: t("items.question5", {}, "We are experiencing long delays in our software development cycles. How can <br /> Nexoria help reduce the time to market for new software features?") }}
                                />
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                    ...
                    <motion.div
                        ...
                        <div className="faq-main__col-02">
                            <motion.h2
                                ...
                                custom={0.2}
                                className="faq-main__title"
                                dangerouslySetInnerHTML={{ __html: t("items.question6", {}, "We have invested in paid advertising but struggle to see significant <br /> ROI. How can Nexoria help optimise our PPC campaigns?") }}
                                />
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
                                ...
                                custom={0.3}
                                className="faq-main__text"
                                dangerouslySetInnerHTML={{ __html: t("items.answer6", {}, "To maximise the ROI of your paid advertising, Nexoria takes a data-driven approach to optimise your PPC campaigns. We begin with an in-depth analysis of your current campaign performance using tools like Google Ads, Facebook Ads Manager, and Google Analytics. We identify where inefficiencies lie by reviewing key metrics like click-through rate (CTR), cost-per-click (CPC), and conversion rates. From there, we refine your targeting strategies, adjust ad copy, and experiment with A/B testing to find what resonates best with your audience. We also focus on optimising landing pages for conversions, ensuring your traffic is directed to user-friendly pages aligned with the ad content. Through continuous monitoring and optimization, we help improve your ad spend efficiency and increase your return on investment.") }}
                            />
                        </div>
                    </motion.div>
                </div>
