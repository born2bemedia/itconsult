                    ...
                    <motion.div
                        ...
                        <div className="work-main__col-01">
                            ...
                            <motion.div
                                ...
                                Complete your specific projects with our end-to-end management. We handle all aspects of the project, ensuring precise execution and timely delivery.
                                <br />
                                <br />
                    ...
                    <motion.div
                        ...
                        <div className="work-main__col-01">
                            ...
                            <motion.div
                                ...
                                custom={0.3}
                                className="work-main__text">
                                Let us manage ongoing functions like IT support or marketing. This approach ensures consistent, reliable service, allowing you to focus on your core business activities.
                                <br />
                                <br />
                                We take over the daily management of functions like IT support or marketing. Our team handles all operational tasks, from monitoring and troubleshooting to strategy execution, ensuring consistent and reliable service. You can focus on your core business activities, knowing that experts efficiently manage and optimise these functions.
                            </motion.div>
                            <motion.div
                                initial="hidden"
                                whileInView="visible"
